...
void UR1PrimaryDataAsset::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
...
FSoftObjectPath UR1PrimaryDataAsset::GetAssetPathByName(const FName& AssetName)
{
...
const FAssetSet& UR1PrimaryDataAsset::GetAssetSetByLabel(const FName& Label)
{
